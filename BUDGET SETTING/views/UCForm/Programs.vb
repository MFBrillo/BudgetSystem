Public Class Programs
    ...
    Private Sub Programs_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        Dim cols() = {"ID", "Program ID", "Sectorid", "Subsectorid"}
    ...
    Private Sub Savebtn_Click(sender As Object, e As EventArgs) Handles Savebtn.Click
        ...
        columnValues.Add("usetemplate", usetemplate)
        columnValues.Add("programdescription", $"'{Programdescriptiontxt.Text}'")
        'columnValues.Add("programcode", $"'{AccountIDtxt.Text}'")
        SqlLoad.MySql_ExecuteNonQueryString("gl_spcprogramslists", columnValues, Nothing, 1)
    End Sub
    Sub Autoprogramcode()
        Dim SqlLoad As New MySQLCore
    ...
    Private Sub DataGridView1_CellContentDoubleClick(sender As Object, e As DataGridViewCellEventArgs) Handles DataGridView1.CellContentDoubleClick
        ...
        sectorid = programname.Rows(0).Item("Sectorid").ToString
        subsectorid = programname.Rows(0).Item("Subsectorid").ToString
        progid = programname.Rows(0).Item("Program ID").ToString
        programcode = programname.Rows(0).Item("Program Code").ToString

        'accountdescription2 = programname.Rows(0).Item("Account").ToString
        OpaquePrompt.Show()
        AddProgram.ShowDialog()
    End Sub
    Private Sub DataGridView1_CellClick(sender As Object, e As DataGridViewCellEventArgs) Handles DataGridView1.CellClick
        ...
        'accountdescription2 = programname.Rows(0).Item("Account").ToString
        'accountcode2 = programname.Rows(0).Item("code").ToString
        'MsgBox(addprogram2)
    End Sub
    ...
    End Sub
    Private Sub Sectoridcbb_SelectedIndexChanged(sender As Object, e As EventArgs) Handles Sectoridcbb.SelectedIndexChanged
    End Sub
