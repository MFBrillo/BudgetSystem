...
#Region "Sub SelectMenu"
    ...
    End Sub
#End Region
    Private Sub Buttons_Click(sender As Object, e As EventArgs) Handles Officebtn.Click
    ...
    Private Sub Officebtn_Click(sender As Object, e As EventArgs) Handles Officebtn.Click
